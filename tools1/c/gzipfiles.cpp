...
int main(int argc, char const* argv[]) {
  ...
  if (argc != 4) {
    ...
    printf(
        "Example:/project/tools1/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
    printf(
        "        /project/tools1/bin/gzipfiles /tmp/idc/surfdata "
        "\"*.xml,*.json\" 0.01\n");
    printf(
        "        /project/tools1/bin/procctl 300 /project/tools1/bin/gzipfiles "
        "/log/idc \"*.log.20*\" 0.02\n");
    printf(
        "        /project/tools1/bin/procctl 300 /project/tools1/bin/gzipfiles "
