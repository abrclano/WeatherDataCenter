/// @brief 程序名:crtsurfdata4.cpp 本程序用于生成全国气象站点观测的分钟数据
/// @brief 作者:alina
...
int main(int argc, char *argv[]) {
  if (argc != 5) {
    ...
    printf(
        "Example:/project/idc1/bin/crtsurfdata4 /project/idc1/ini/stcode.ini "
        "/tmp/idc/surfdata /log/idc/crtsurfdata4.log xml,json,csv\n\n");
