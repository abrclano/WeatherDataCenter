/// @brief 程序名:crtsurfdata.cpp 本程序用于生成全国气象站点观测的分钟数据
/// @brief 作者:alina
...
int main(int argc, char *argv[]) {
  if ((argc != 5) && (argc != 6)) {
    ...
    printf(
        "Example:/project/idc1/bin/crtsurfdata /project/idc1/ini/stcode.ini "
        "/tmp/idc/surfdata /log/idc/crtsurfdata.log xml,json,csv\n");
    printf(
        "        /project/idc1/bin/crtsurfdata /project/idc1/ini/stcode.ini "
        "/tmp/idc/surfdata /log/idc/crtsurfdata.log xml,json,csv, "
        "20230129213000\n");
    printf(
        "        /project/tools1/bin/procctl 60 /project/idc1/bin/crtsurfdata "
        "/project/idc1/ini/stcode.ini /tmp/idc/surfdata "
    ...
    printf(
        "datafmt "
        "生成数据文件的格式，支持xml、json和csv三种格式，中间用逗号分隔。\n");
